...
namespace Interna.Entity
{
    public class Scanner
    {
        ...
        private int width_pixel = 600;
        private int height_pixel = 1010;
        private int color_mode = 1;
        public string nombreEscaner { get; set; }

        public Scanner(DeviceInfo deviceInfo)
        {
            this._deviceInfo = deviceInfo;
            nombreEscaner = deviceInfo.Properties["Name"].get_Value().ToString();
        }
