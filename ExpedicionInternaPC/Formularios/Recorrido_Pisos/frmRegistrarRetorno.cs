...
{
    public partial class frmRegistrarRetorno : frmChild
    {
        ...
        private void RegistrarRetornoRecorrido()
        {
            ...
            try
            {
                Registro registro = Metodos.RegistrarRetornoRecorrido(horario, txtDni.Text);
            ...
            {
                Program.mensajeError("Ha ocurrido un error al intentar registrar el retorno de recorrido.");
            }
        ...
        public frmRegistrarRetorno()
        {
            InitializeComponent();
        }

        private void frmRegistrarRetorno_Load(object sender, EventArgs e)
        {
