...
{
    public partial class frmConsultaCorrespondenciaGeneralDetalle : frmChild
    {
        #region Metodos
        ...
        private void Buscar()
        {
            ...
            try
            {
                lObjetos = Metodos.ConsultaElementosReporteGeneralDetalle((int)lueEstado.EditValue, (int)lueTipoEntrega.EditValue, (int)lueSedeOrigen.EditValue, (int)lueSedeDestino.EditValue, (int)radioGroupFechaDe.EditValue, (DateTime)dteDesde.EditValue, (DateTime)dteHasta.EditValue);
            }
            catch (InvalidTokenException)
            {
                Program.mensajeTokenInvalido();
        ...
        public frmConsultaCorrespondenciaGeneralDetalle()
        {
            InitializeComponent();
        }
