...
angular.module('simihApp').controller('ReportePendientesCustodia',
    function ($scope, $rootScope, $modal, uiGridConstants, $timeout, ExportarService, UtilsService, $filter, Requester) {
            ...
            mostrarOcultarDetalle: function (fechaInicial, fechaFinal) {
                ...
                if ($scope.configuracion.nombreBotonMostrarOcultarDetalle == 'Mostrar Detalle') {
                    ...
                    if ($scope.totalReclamos == 0) {
                        ...
                        Requester.AuthorizationPost($rootScope.rutaWebGeneral + 'ListarEstadosIndicadorCustodia', { dFechaInicial: fechaInicial, dFechaFinal: fechaFinal }).then(function (data) {
        ...
        */
        ...
        var buscarReportePendientes = function (fechaInicio, fechaFin) {
            ...
            Requester.AuthorizationPost($rootScope.rutaWebGeneral + 'ListarCantidadEstadosIndicadorCustodia', { dFechaInicial: fechaInicio, dFechaFinal: fechaFin }).then(function (data) {
                ...
                if (data == undefined || data == null || data.length == 0) {
                    ...
                    var dataSet = {
                        labels: ["Custodiados en Sede Origen", "Ruta Sucursal", "Ruta Agencia", "Custodiados en Sede Destino", "Ruta Pisos"],
                        datasets: [
