...
angular.module('simihApp').controller('ReporteEstadosCustodia',
        ...
        var buscarReporteEstados = function (fechaInicio, fechaFin) {
            ...
            Requester.AuthorizationPost($rootScope.rutaWebGeneral + 'ListarCantidadEstadoAutogeneradoActualCustodia', { dFechaInicial: fechaInicio, dFechaFinal: fechaFin }).then(function (data) {
                ...
                if (data == undefined || data == null || data.length == 0) {
                    ...
                    var dataSet = {
                        labels: ["Custodiados en Sede Origen", "Ruta Sucursal", "Ruta Agencia", "Custodiados en Sede Destino", "Ruta Pisos", "Recibidos", "Confirmados", "Retirados"],
                        datasets: [
                            {
                                //label: "Cantidad",
                                data: [
