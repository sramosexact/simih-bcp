angular.module('simihApp').controller('ReportePorMatriculaController',
...
/*            autoResize: true,*/
        ...
        $scope.gridReportePorMatricula.onRegisterApi = function (gridApi) {
        ...
        $scope.gridReportePorMatricula.data = [];

        $scope.generarReportePorMatricula = () => {
            Requester.AuthorizationPost($rootScope.rutaWebGeneral + 'ReportePorMatricula', {
                "matricula": $scope.matricula,
                "fechaInicio": $scope.fromDate,
                "fechaFin": $scope.untilDate
            }).then(function (data) {
                $scope.gridReportePorMatricula.data = data;
            }, function (status) {
                $alert(
                    {
                        title: 'ALERTA!',
        ...
        $scope.exportarReporte = () => {
            ...
            ObjetoExportar.NameReporte = "ReportePorMatricula";
            var obj = [];
            var datosExportar = [];
            angular.copy($scope.gridReportePorMatricula.data, datosExportar);
