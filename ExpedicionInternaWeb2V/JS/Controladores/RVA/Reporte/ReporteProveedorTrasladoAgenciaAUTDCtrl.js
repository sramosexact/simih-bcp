app.controller('ReporteProveedorTrasladoAgenciaAUTDCtrl', ['$scope', '$rootScope', '$http', 'ServiciosApi', '$location', '$timeout', 'Exportar', '$filter', 'uiGridConstants', 'NgTableParams', 'TIPO',
    function ($scope, $rootScope, $http, ServiciosApi, $location, $timeout, Exportar, $filter, uiGridConstants, NgTableParams, TIPO) {
        ...
        *************************************/
        ...
        $scope.getObtenerDetalleRecepcion = function (proveedor) {
            ...
            ServiciosApi.getGenerarReporteRecepcionDetalleLima(pFechaDesde, pFechaHasta).then(function (data) {
                ...
                $scope.RegistroAgenciasDataSource = data.filter((x) => {
                    return x.sProveedor == proveedor.Objeto.Proveedor;
                });
        ...
        $scope.mostrarDetalle = function (index) {
          ...
          if (proveedor.textoBotonDetalle === 'Mostrar detalle') {
              if (!proveedor.detalleCargado) {
                $scope.getObtenerDetalleRecepcion(proveedor);
