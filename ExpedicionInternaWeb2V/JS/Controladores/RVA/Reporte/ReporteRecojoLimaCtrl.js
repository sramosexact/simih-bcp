app.controller('ReporteRecojoLimaCtrl', ['$scope', '$rootScope', '$http', 'ServiciosApi', '$location', '$timeout', 'Exportar',
    function ($scope, $rootScope, $http, ServiciosApi, $location, $timeout, Exportar) {
        ...
        *******************************/
        $scope.ObtenerAgenciaReportadas = function () {
            ...
            ServiciosApi.getGenerarReporteRecojoLima(strDesde, strHasta, $scope.TipoProveedor).then(function (data) {
                if (data.length === 0) {
                    $scope.verExportar = false;
            ...
            if (idProveedor !== 0) {
                angular.forEach($scope.Proveedores, function (value, index) {
                    if (idProveedor === value.Objeto.IdProveedor) {
                        ...
                        ObjetoExportar.NameReporte = "ReporteRecojo";
                        ...
                        ObjetoExportar.detalle = [
                            ["Pendiente", value.Objeto.PendientesPorcentaje, value.Objeto.Pendientes]
                        ]
                        ...
                        ObjetoExportar.Config.RowBackgroundColor = "#fff";
                        ObjetoExportar.Config.RowFontColor = "rgb(117,113,113)";
                        ObjetoExportar.Config.FontWeight = "initial"

                        ObjetoExportar.cabecera = [
                            "Visitados",
                            value.Objeto.VisitadosPorcentaje,
                            value.Objeto.Recogidos + value.Objeto.SinMovimiento
                        ];
                        ...
                        ObjetoExportar.detalle = [
                            ...
                            ["Sin Movimiento",
                                value.Objeto.SinMovimientoPorcentaje,
                                value.Objeto.SinMovimiento]
                        ];
